...
public class six extends Box{
    ...
    private void getItems() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://script.google.com/macros/s/AKfycbzqt_BjErRvCkyLOdiPo2a84AKcfZYfE-Rr4xFfT9EyvupDH2g/exec?action=getItems",
    ...
    private void parseItems(String jsonResposnce) {
        ...
        try {
            ...
            JSONArray jarray = jobj.getJSONArray("Cylindrical_Roller");
