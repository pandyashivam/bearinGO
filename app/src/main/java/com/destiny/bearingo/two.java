...
public class two extends Box{
    ...
    private void getItems() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://script.google.com/macros/s/AKfycbzu4OyU6THGewdjPKIc4bPC3VdIrEtASDo2vh2k1t9ohL1zheQp/exec?action=getItems",
    ...
    private void parseItems(String jsonResposnce) {
        ...
        try {
            ...
            JSONArray jarray = jobj.getJSONArray("Angular_Contact");
