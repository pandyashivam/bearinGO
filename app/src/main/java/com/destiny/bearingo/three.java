...
public class three extends Box{
    ListView listView;
    ListAdapter adapter;
    ...
    private void getItems() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://script.google.com/macros/s/AKfycbyDnAsvfzxr0Cih-r93vVKZPmNe6mld7rsMcIp4i20yjT8-MZLS/exec?action=getItems",
    ...
    private void parseItems(String jsonResposnce) {
        ...
        try {
            ...
            JSONArray jarray = jobj.getJSONArray("Double_Row_Angular");
