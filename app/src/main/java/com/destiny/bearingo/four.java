...
public class four extends Box {
    ...
    private void getItems() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://script.google.com/macros/s/AKfycbzgnBIHgp7SSt_d7n5bbOUMYmYi0PTsUrJweJhbzYDdJOdVa2k/exec?action=getItems",
    ...
    private void parseItems(String jsonResposnce) {
        ...
        try {
            ...
            JSONArray jarray = jobj.getJSONArray("Self_Aligning");
