...
public class seven extends Box {
    ListView listView;
    ListAdapter adapter;
    ...
    private void getItems() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://script.google.com/macros/s/AKfycbyimDigbuRFegozmEf8YAxt-kAhhN49Xv1N1Y9LBH-99fTrFMQ/exec?action=getItems",
    ...
    private void parseItems(String jsonResposnce) {
        ...
        try {
            ...
            JSONArray jarray = jobj.getJSONArray("Double_Row_Cylindrical");
