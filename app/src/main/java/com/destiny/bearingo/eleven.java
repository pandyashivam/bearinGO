...
public class eleven extends Box {
    ...
    private void getItems() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://script.google.com/macros/s/AKfycbztVh4Jl6ekCV8J14SAzgnJNCOhadUiBS4T_s_aiK_SA-m5Jko/exec?action=getItems",
    ...
    private void parseItems(String jsonResposnce) {
        ...
        try {
            ...
            JSONArray jarray = jobj.getJSONArray("Double_Row_Cylindrical_Tape");
