...
public class eight extends Box {
    ListView listView;
    ListAdapter adapter;
    ...
    private void getItems() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://script.google.com/macros/s/AKfycbwso8KJQqXYWV12IF-OmfJmZSMji3mlwxC_PBRbsNgRtchwN7o/exec?action=getItems",
    ...
    private void parseItems(String jsonResposnce) {
        ...
        try {
            ...
            JSONArray jarray = jobj.getJSONArray("Extra_Small");
